<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="AssetManagement.WebForm8" %>
                    ...
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <div class="form-group row" style="margin-left: 30%; margin-right: 30%">
                                <asp:Button ID="SubmitButton" CssClass="btn btn-block btn-warning waves-light" runat="server" OnClick="adduser" Text="Submit" Width="70%" />
                            </div>
                        </div>
                    </div>
                </div>
