<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="UpdateUser.aspx.cs" Inherits="AssetManagement.WebForm7" %>
                                ...
                                <div class="col-12">
                                    <div class="card m-b-30">
                                        <div class="card-body"> 
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-4 col-md-4">
                                                    <asp:Label ID="NameLabel" runat="server" for="example-text-input" class="col-sm-2 col-form-label" Text="Name"></asp:Label>
                                                </div>
                                                <div class="col-sm-7 col-md-7">                                                    
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-4 col-md-4">
                                                    <asp:Label ID="MobileLabel" runat="server" for="example-text-input" class="col-sm-2 col-form-label" Text="Mobile"></asp:Label>
                                                </div>
                                                <div class="col-sm-7 col-md-7">                                                    
                                                    <asp:TextBox runat="server" ID="Mobile" class="form-control" TextMode="Phone"></asp:TextBox> 
                                                </div>
                                            </div>                                          
                                            <div class="form-group row">
                                                <div class="col-sm-4 col-md-4">
                                            ...
                                            <div class="form-group row" style="margin-left:30%;margin-right:30%">                                                                                      
                                                <asp:Button ID="SubmitButton" CssClass="btn btn-block btn-warning waves-light" runat="server" OnClick="updateuser" Text="Submit" Width="70%"  />
                                            </div>
                                        </div>
